...
default_folder = "results/" #main folder of each execution #remember to create this folder
atyimo_path = "/path/to/atyimo/"

##----##----##----##----##----##----##----##----##----##----##----##----##----##--------##----##----##----##----##----##----
# Set everything to be used in preprocessing module
#Larger base
#Larger input file to the preprocessing module 
pp_larger_input_file = "datasets/dataset_a.csv"
...
pp_larger_type_date3 = 1 #day<"-"||"/">month<"-"||"/">year examples: 14/mar/08 or 14/mar/2008 or 1-Dec-2006 or 1-Dec-06
...
pp_larger_col_mn = 4			#Mother name
pp_larger_col_bd = 2          	#Birth date
pp_larger_col_g =  3   			#Gender
pp_larger_col_mr = 5      		#Municipality residence
pp_larger_col_st = -1  			#State

#Smaller base
#Smaller input file to the preprocessing module
pp_smaller_input_file = "datasets/dataset_b.csv"
...
pp_smaller_type_date3 = 1 # day<"-"||"/">month<"-"||"/">year examples: 14/mar/08 or 14/mar/2008 or 1-Dec-2006 or 1-Dec-06 (only for years after 1999)
...
pp_smaller_col_mn = 4		#Mother name
pp_smaller_col_bd = 2		#Birth date
pp_smaller_col_g = 3		#Gender
pp_smaller_col_mr = 5		#Municipality residence
